...
#define POOL_PARAM(type, poolPtr)                                                                 \
	...
	{                                                                                             \
	public:                                                                                       \
		ParamCast(AMX* amx, cell* params, int idx, int& error = ParamCastErrorCode_None) noexcept \
		{                                                                                         \
...
{
public:
	ParamCast([[maybe_unused]] AMX* amx, cell* params, int idx, int& error = ParamCastErrorCode_None)
